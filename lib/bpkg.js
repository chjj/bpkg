...
class Bundle {
  ...
  init(options) {
    ...
    if (typeof options.convertESM === 'boolean')
      this.convertESM = options.convertESM;
...
class Module {
  ...
  async transform(code) {
    ...
    if (this.bundle.multi && !this.bundle.convertESM)
      return code;
