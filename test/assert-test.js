...
describe('Assert', function() {
  ...
  it('should do assert.equal', () => {
    ...
    assert.throws(() => assert.notEqual(null, undefined));
  ...
  it('should do assert.strict.equal', () => {
    assert.strict.equal(1, 1);
    assert.strict.equal(true, true);
    assert.strict.notEqual(null, undefined);
    assert.strict.notEqual({}, {});
    assert.strict.notEqual(0, '0');
    assert.strict.notEqual(1, '1');

    assert.throws(() => assert.strict.notEqual(1, 1));
    assert.throws(() => assert.strict.notEqual(true, true));
    assert.throws(() => assert.strict.equal(false, true));
    assert.throws(() => assert.strict.equal(null, undefined));
    assert.throws(() => assert.strict.equal({}, {}));
