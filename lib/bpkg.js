...
class Package {
  ...
  async _replicate(dest, optional) {
    ...
    await this.traverse(async (file, stat) => {
      ...
      let code = await this.bundle.final(module, await module.compile());
      let mode = 0o644;
